...
const Footer = () => {
  ...
  return (
    <div className="w-full flex items-center justify-center bg-black pt-7">
      <div className="w-full px-4 text-[#d2a50a] flex flex-col">
        ...
        <div className="flex mt-7 flex-col md:flex-row md:justify-between">
          <p className="w-full md:w-2/3 text-[#d2a50a]">
            To ensure that all Wikipedia content is verifiable, anyone may question an uncited claim. If your work has
            been tagged
          </p>
          <div className="w-44 pt-6 md:pt-0">
            <a className="bg-[#d2a50a] text-dark justify-center text-center text-black font-semibold rounded-lg shadow px-10 py-3 flex items-center">
              Contact Us
            </a>
          </div>
        </div>
        <div className="flex flex-col">
          <div className="flex mt-10 mb-12 flex-row items-center   justify-between">
            ...
            <a className="hidden md:block cursor-pointer text-[#d2a50a] hover:text-white uppercase">About</a>
            <a className="hidden md:block cursor-pointer text-[#d2a50a] hover:text-white uppercase">Services</a>
            <a className="hidden md:block cursor-pointer text-[#d2a50a] hover:text-white uppercase">Why us</a>
            <a className="hidden md:block cursor-pointer text-[#d2a50a] hover:text-white uppercase">Contact Us</a>
          ...
          <hr className="border-[#d2a50a]" />
          <p className="w-full text-center my-7 text-[#d2a50a]">Copyright &copy; {year} ...and ORDEN</p>
        </div>
      </div>
    </div>
  );
