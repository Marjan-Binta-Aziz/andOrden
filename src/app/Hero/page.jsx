...
function Hero() {
  return (
    <div
      ...
      className="flex justify-between  items-center px-10 py-1 w-full gap-4 relative"
    >
      <div className="w-9/12 ">
        <Swiper
          className="w-full h-full rounded-2xl gap-4"
          slidesPerView={1}
          centeredSlides={true}
          zoom={true}
          rewind={true}
        ...
        >
          {projects.map((project) => (
            <SwiperSlide className="">
              <div className="h-96">
                <img className="h-full w-full !object-cover" alt="gallery" src={project.img} />
              </div>
            </SwiperSlide>
          ))}
        </Swiper>
